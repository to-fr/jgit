...
public class LfsFactory {
	...
	// private static final ThreadLocal<CredentialsProvider>
	// credentialsProviderHolder = new ThreadLocal<>();
	private static CredentialsProvider credentialsProviderHolder;
	...
	public static CredentialsProvider getCredentialsProvider() {
		return LfsFactory.credentialsProviderHolder;
	}

	/**
	 * @param credentialsProvider
	 *            set credentials provider used by LFS.
	 */
	public static void setCredentialsProvider(
			CredentialsProvider credentialsProvider) {
		LfsFactory.credentialsProviderHolder = credentialsProvider;
	}
...
//		LfsFactory.credentialsProviderHolder = null;
//	}
